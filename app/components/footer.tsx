      ...
      <div className="py-14 px-6 sm:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 text-sm">Welcome to Our store! In our store all groccesry, cooking,  Items are available Plwease visit our store </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <p className="text-gray-300 text-sm">UP More New Karachi</p>
              <p className="text-gray-300 text-sm">contact@chaseup.com</p>
